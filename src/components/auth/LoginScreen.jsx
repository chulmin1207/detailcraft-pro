...
/**
 * 로그인 화면 컴포넌트
 * 원본 index.html lines 764-793 (.login-screen, .login-container, .login-btn 등) 기반
 *
 * Google OAuth 로그인 버튼, 로딩 스피너, 에러 메시지를 표시한다.
 * 인증 상태에 따라 로그인 폼/로딩/에러 중 하나를 보여준다.
 */
export default function LoginScreen() {
  const { authLoading, authError, startGoogleLogin } = useAuth();
