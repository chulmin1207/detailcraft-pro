...
export function markdownToHtml(md) {
    return md
        ...
        .replace(/섹션번호:/g, '<strong style="color: var(--accent-secondary);">섹션번호:</strong>')
        .replace(/섹션명:/g, '<strong style="color: var(--accent-primary-hover);">섹션명:</strong>')
        .replace(/목적:/g, '<strong>목적:</strong>')
        .replace(/헤드라인:/g, '<strong>헤드라인:</strong>')
        .replace(/서브카피:/g, '<strong>서브카피:</strong>')
        .replace(/비주얼 지시:/g, '<strong style="color: var(--accent-gemini);">비주얼 지시:</strong>')
        .replace(/\n/g, '<br>');
}
